                ...
                if (emailValidationResult != null) {
                  ...
                  if(passController.text == confirmPassController.text){
                    if(passController.text.length > 6){
                      ...
                      setState(() {
                        responseValue = "Minimum 6 characters"; //AppLocalizations(context).translate("min_characters");
                      });
                    }
               } else {
                    setState(() {
                      responseValue = "Passwords do not match";// AppLocalizations(context).translate("password_mismatch");
                    });
                  }
              }
              }else {
